          ...
          <div className="row">
            <div className="career_container">
              ...
              <p className="text-center">
                ...
                approach to every team member helps in making the organization a
                success in every endeavor it ventures into.
              </p>
              <br />
              <div
          ...
          <div className="row">
            <div className="career_container">
              ...
              <p className="text-center">
                ...
                and connectivity. We’re dedicated to having an environment where
                everyone can thrive by emphasizing intense diversity,
              ...
              <div className="benfits mt-3 d-flex ">
                ...
                <div className="benfit_content">
                  ...
                  {/* <p>
                    ...
                    Enim quas nihil maiores voluptatibus sint eius consequuntur
                    placeat.
                  </p> */}
                </div>
              </div>
