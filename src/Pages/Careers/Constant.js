...
//@@@@ careers at sakshath @@@@@@@
export const FULLFILLMENT_IMG = require("../../Assets/images/careers_at_sakshath_1st_row.png");
export const FULL_WELLNESS_IMG = require("../../Assets/images/careers_sakshath_fun_wellness.png");
export const EXCELLENCE_IMG = require("../../Assets/images/careers_sakshath_growth_wellness.png");


//@@@@@  career_footprint @@@@@@@@@@
export const bangalore_img1 = require("../../Assets/images/bang_img1.jpeg");
export const bangalore_img2 = require("../../Assets/images/bang_img2.jpeg");
export const bangalore_img3 = require("../../Assets/images/bang_im3.jpeg");
